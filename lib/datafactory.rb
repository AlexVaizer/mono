module DataFactory
	...
	module DataFactory::ETH
		...
		MOCK_DATA = {
			...
			balance: [{"account"=>"0xA07fDc4A73a067078601a00C36dc6627FA0A80B8", "balance"=>"1881190803163104475"},{"account"=>"0xA07fDc4A73a067078601a00C36dc6627FA0A80B8", "balance"=>"1881190803163104475"}],
